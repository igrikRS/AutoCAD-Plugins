...
namespace LayoutsFromModel
{
    ...
    public class UserAutoBlocksBordersBuilder : IBordersCollectionBuilder
    {
        ...
        // функция проверяет существует ли заданный атрибут в определённом вхождении (экземпляре) блока
        ...
        // функция возвращает текст заданного атрибута в определённом вхождении (экземпляре) блока
        ...
        // функция сортировки текстовых нумирований листов
