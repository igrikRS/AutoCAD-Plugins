...
{
    /// <summary>
    /// Обработка первоначального взаимодействия с пользователем.
    /// Получение номера первого листа. Работа с конфигурацией.
    ...
    public class InitialUserInteraction
    {
        ...
        public void GetInitialData()
        {
            ...
            do
            {
                ...
                // Базовый шаблон должен всегда быть в папке с dll
